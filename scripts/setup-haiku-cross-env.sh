...
install_haiku_packages() {
    ...
    # Note: gcc_syslibs_devel is not downloaded separately as libstdc++ and other
    # system libraries should be provided by the cross-compiler toolchain itself.
    # If linking fails with "cannot find -lstdc++", we may need to add it back.
